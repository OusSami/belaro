...
export const FOOTER_LINKS = {
  shop: [
    ...
    { name: "Tech Packs", href: "/categories/tech-packs" },
    { name: "Mockups", href: "/categories/mockups" },
    { name: "Brushes", href: "/categories/brushes" },
    { name: "Patterns", href: "/categories/patterns" },
  ],
  support: [
